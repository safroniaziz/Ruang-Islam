...
<html lang="en">
  <head>
    ...
    <title>Ruang Islam | @yield('title') </title>
  ...
  <body class="nav-md sidebar_fixed" >
      ...
      <div class="main_container" style="background:#013C62;">
        ...
        <div class="left_col scroll-view" style="background: #013C62 !important;">
            <div class="navbar nav_title" style="border-bottom: 1px white solid;; margin:0; padding-bottom:5px 0px !important; background:#013C62;">
                <a href="index.html" class="site_title" style="font-weight:600; font-size:20px; text-align:center"> <span><b>RUANG </b> ISLAM</span></a>
              </div>
            ...
            <div class="sidebar-footer hidden-small" style="background:#172D44;">
                <p style="color:white;text-align:center; margin-bottom:0px; padding:5px;">Ruang Islam</p>
            </div>
            <!-- /menu footer buttons -->
          </div>
        </div>
   ...
   <script src="{{ asset('assets/backend/vendors/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    ...
    <!-- Input Tags -->
    <script src="{{ asset('assets/backend/vendors/jquery.tagsinput/src/jquery.tagsinput.js') }}"></script>
    <!-- Custom Theme Scripts -->
    <script src="{{ asset('assets/backend/build/js/custom.js') }}"></script>
