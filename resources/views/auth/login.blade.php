...
<html>
		...
		<div id="particles-js">
            <div class="loginBox">
                ...
                @if ($errors->any())
                    ...
                    <p style="text-align:center; margin-bottom:20px;">Administrator Kamus Istilah <br> Dalam Islam</p>
                @endif
    ...
    <script type="text/javascript" src=" {{ asset('assets/vendors/particles/particles.min.js') }} "></script>
    <script type="text/javascript" src=" {{ asset('assets/vendors/particles/app.js') }} "></script>
